        ...
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="menu-content pb-60 col-lg-10">
                    <div class="title text-center">
                        <h1 class="mb-10">Về nhân sự của thúng tôi</h1>
            ...
            <div class="row">
                <div class="active-exibition-carusel text-center">
                    <div class="single-exibition item">
                        ...
                        <ul class="tags"></ul>
                        <a href="#"><h4>Nguyễn Văn Mạnh</h4></a>
                        <p>
                            Giới thiệu về nhân sự Giới thiệu về nhân sự Giới thiệu về nhân sự Giới thiệu về nhân sự .
                        </p>
                    ...
                    <div class="single-exibition item">
                        <img class="img-fluid rounded-circle" src="https://via.placeholder.com/360x360.png?text=%E1%BA%A3nh%20ch%C3%A2n%20dung%20demo" alt="">
                        <ul class="tags"></ul>
                        <a href="#"><h4>Nguyễn Văn Mạnh</h4></a>
                        <p>
                            Giới thiệu về nhân sự Giới thiệu về nhân sự Giới thiệu về nhân sự Giới thiệu về nhân sự .
